...
#
./AlcoR redundancy -v -n -m 13:50:0:1:10:0.9/5:10:0.9 --dna -w $WINDOW -t 0.5 sampleB.fasta 1> pos_05.txt
./AlcoR redundancy -v -n -m 13:50:0:1:10:0.9/5:10:0.9 --dna -w $WINDOW -t 1.0 sampleB.fasta 1> pos_10.txt
./AlcoR redundancy -v -n -m 13:50:0:1:10:0.9/5:10:0.9 --dna -w $WINDOW -t 1.5 sampleB.fasta 1> pos_15.txt
#
