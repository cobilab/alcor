...
for GENOME in "${GENOMES[@]}"
  do
  ./AlcoR redundancy -v --hide --color 100 --threshold $THRESHOLD --ignore 50 --dna -w 50 -m 13:50:0:1:10:0.9/3:10:0.9 $GENOME.fa > $GENOME-d.txt
  ./AlcoR redundancy -v --no-size --hide --threshold $THRESHOLD --color 1 --ignore 50 --dna -w 50 -m 13:50:5000:1:10:0.9/3:10:0.9 $GENOME.fa > $GENOME-l.txt
